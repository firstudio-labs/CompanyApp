...
<head>
    ...
    <title>Login - Firstudio Company App</title>
...
<body>
    <div class="container-xxl d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="authentication-wrapper authentication-basic container-p-y w-100" style="max-width: 400px;">
            <div class="authentication-inner">
                ...
                <div class="card login-card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-2 text-center">Selamat Datang di Firstudio 👋</h4>
                        <p class="mb-4 text-center">Masuk ke akun Anda untuk mengelola layanan digital perusahaan Anda.</p>
                        @if (session('error'))
