                        ...
                        <div class="mb-3">
                            ...
                            <div id="tech-stack-group">
                                <div class="input-group mb-2 tech-stack-row">
                                    <select name="tech_stack_ids[]" class="form-control select-techstack @error('tech_stack_ids.0') is-invalid @enderror">
                                        ...
                                        @foreach($techStacks as $stack)
                                            <option value="{{ $stack->id }}"
                                                ...
                                                {{ (old('tech_stack_ids.0') == $stack->id) ? 'selected' : '' }}>
                                                {{ $stack->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                @if(old('tech_stack_ids'))
                                    @foreach(old('tech_stack_ids') as $i => $oldId)
                                        @if($i > 0)
                                        <div class="input-group mb-2 tech-stack-row">
                                            ...
                                            <button type="button" class="btn btn-outline-danger remove-tech-stack" title="Hapus"><i class="bx bx-minus"></i></button>
                                        </div>
                                        @endif
                                    @endforeach
                                @endif
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <h5 id="preview-title">{{ old('title') ?: 'Judul Produk' }}</h5>
