...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Kategori /</span> Tambah Kategori
    </h4>
    @if ($errors->any())
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <span class="badge bg-info fs-5" id="preview-name">{{ old('name') ?: 'Nama Kategori' }}</span>
                    <div class="text-muted mt-2" id="preview-description">{{ old('description') ?: 'Deskripsi kategori akan tampil di sini...' }}</div>
                </div>
            </div>
        </div>
    </div>
